    ...
    onSearchClick: function onSearchClick(selectedPlaces) {
      ...
      var newUrl = {
        ...
        query: _objectSpread({}, values, {
          dateFrom: Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["format"])(new Date(values.dateFrom), "DD/MM/YYYY"),
          flyFrom: typeof values.flyFrom === "string" ? values.flyFrom : values.flyFrom.id,
          dateTo: values.dateTo && Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["format"])(new Date(values.dateTo), "DD/MM/YYYY"),
...
//# sourceMappingURL=index.js.f004886ea3f29e0be81a.hot-update.js.map